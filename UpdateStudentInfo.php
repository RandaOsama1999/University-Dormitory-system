                ...
                <br>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="dateofbirth" id="dateofbirth" style="margin-left: 84%" style="direction:RTL;" value='<?php echo $DateOfBirth; ?>'  required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="GradeID"  class="form-control" style="direction:RTL;" value='<?php echo $Grade_ID; ?>' required>
                         ...
                         $conn = $connection->connect();
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="facultyID" class="form-control" style="direction:RTL;" value='<?php echo $Faculty_ID; ?>' required>
