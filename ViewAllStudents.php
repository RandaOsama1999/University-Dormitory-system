                                                ...
                                                if ($result->num_rows > 0) {
                                                    while($row = $result->fetch_assoc()) {
                                                        ...
                                                        if ($resulttwo->num_rows > 0) {
                                                            while($rowtwo = $resulttwo->fetch_assoc()) {
                                                                $Grade_ID=$rowtwo['Grade_ID'];
                                                                $Faculty_ID=$rowtwo['Faculty_ID'];
                                                                $sqltwo = "SELECT * FROM faculties WHERE ID=$Faculty_ID";
                                                        $resulttwo = $conn->query($sqltwo);
                                                        if ($resulttwo->num_rows > 0) {
                                                            while($rowtwo = $resulttwo->fetch_assoc()) {
                                                                echo "<td style='color:#514F4E;'>" . $rowtwo['Faculty'] . "</td>";
                                                            }
                                                        }
                                                        $sqltwo = "SELECT * FROM grades WHERE ID=$Grade_ID";
                                                        $resulttwo = $conn->query($sqltwo);
                                                        if ($resulttwo->num_rows > 0) {
                                                            while($rowtwo = $resulttwo->fetch_assoc()) {
                                                                echo "<td style='color:#514F4E;'>" . $rowtwo['Grade'] . "</td>";
                                                            }
                                                        }
                                                            }
                                                        }
