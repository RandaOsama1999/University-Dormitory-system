...
$conn = $connection->connect();
            ...
            if(isset($_POST['remove'])){
                header('location: UpdateStaticPageAfterSearch.php?name='.$_POST['html']);
            }
            $conn->close();
?>
<!DOCTYPE html>
            ...
            <div class="container-fluid">
                ...
                <div class="form-validation">
                    ...
                    ?>
                        ...
                        <button type="submit" name="remove" class="btn btn-primary btn-flat m-b-30 m-t-30">تعديل</button>
