...
$conn = $connection->connect();
 ...
 { 
     ...
     $connection->update("statichtml","html='$html',LastUpdatedDateTime='$today'","pagename='$name'");
        ...
        $resultone = $conn->query($sqlone);
           ...
           while($rowT= $resultone->fetch_assoc())
                {  
                    ...
                    {
                           $html=$rowT["html"];
                           $iscreated=$rowT["CreatedDateTime"];
                           $lastmodified=$rowT["LastUpdatedDateTime"];
                           $isdeleted=$rowT["IsDeleted"];
                    }
                }
                echo $html;
?>
