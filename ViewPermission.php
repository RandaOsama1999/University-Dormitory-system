                                            ...
                                            <?php
                                                ...
                                                if ($result->num_rows > 0) {
                                                    while($row = $result->fetch_assoc()) {
                                                        ...
                                                        $lin_ID=$row['links_ID'];
                                                        echo "<tr>";
                                                        $sqlt = "SELECT * FROM links WHERE ID=$lin_ID AND IsDeleted=0";
                                                        $resultt = $conn->query($sqlt);
                                                        if ($resultt->num_rows > 0) {
                                                            while($rowt = $resultt->fetch_assoc()) {
                                                                echo "<td style='color:#514F4E;'>" . $rowt['FriendlyAddress'] . "</td>";
                                                            }
                                                        }

                                                        $sqltw = "SELECT * FROM usertype WHERE ID=$usert_ID AND IsDeleted=0 ";
                                                        $resulttw = $conn->query($sqltw);
                                                        if ($resulttw->num_rows > 0) {
                                                            while($rowtw = $resulttw->fetch_assoc()) {
                                                                echo "<td style='color:#514F4E;'>" . $rowtw['Type'] . "</td>";
                                                            }
                                                        }
