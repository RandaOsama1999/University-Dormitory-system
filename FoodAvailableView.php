...
class FoodAvailableView
{
     public static function MakeRequest()
	{
        
            include_once "header.php";
            $Result=FoodAvailable::SelectAll();
        ...
        public static function AddNewFood()
        {
            include_once "header.php";
            echo '<div id="x2">
            ...
            <div id="div_ctrl"    >
            <label for="user" class="label" style="margin-left: 85%;font-size:20px;color:black;padding:10px;">اسم الاكله<span class="text-danger">*</label>
            <input id="user" type="text" name="Name"  style="margin-left: 80%;"pattern="{أ-ي]{1,30\s]" title="اكتب باللغه العربيه" onkeypress="return CheckArabicCharactersOnly(event);"  required >
            </div>
            <div id="div_ctr2"    >
...
if (unicode != 8)
 { //if the key isnt the backspace key (which we should allow)
        ...
        else 
        {
            ...
            $alert2=Content::Alert(42,"alert2");
            echo'
            alert("'.$alert2.'");
...
{ 
  ...
  if ( quantity>=1 && quantity<=50 ) 
   ...
   { ';
      $alert3=Content::Alert(42,"alert3");
      echo'
      alert("'.$alert3.'");
       return false;
     }
...
include_once "footer.php";
        ...
        public static function UpdateQuantity()
        {
            ...
            <div id="div_ctrl2"   " >
            <label for="user" class="label" style="margin-left: 80%;font-size:20px;color:black;padding:10px;">اختار نوع الاكله لتغير الكميه<span class="text-danger">*</label>
      ...
      echo'</select> 
            ...
            $cont3=Content::Button(43,"Update");
            echo '
 ...
 { //if the key isnt the backspace key (which we should allow)
        ...
        else 
        {
            if ((unicode >= 48 && unicode <= 57) || (unicode >= 65 && unicode <= 90) || (unicode >= 97 && unicode <= 122)
             || (specialKeys.indexOf(e.unicode) != -1 && e.charCode != e.unicode)) 
            //if not a number or arabic';
            $alert2=Content::Alert(43,"alert2");
            echo'
            alert("'.$alert2.'");
            return false; //disable key press
         }
...
{ 
  ...
  if ( quantity>=1 && quantity<=50 ) 
   ...
   { ';
      $alert3=Content::Alert(43,"alert3");
      echo'
      alert("'.$alert3.'");
       return false;
     }
...
include_once "footer.php";
        ...
        public static function Delete()
        {
            ...
            <div id="div_ctrl2"   " >
            <label for="user" class="label" style="margin-left:75%;font-size:20px;color:black;padding:5px;">اختار نوع الاكله اللي عايز تشيلها <span class="text-danger">*</label>
            <select name="CurrentOptions2" id="CurrentOptions2ID" style="margin-left: 80%;width:170px;" > 
           <option value="0"   >    دوس علي السهم علشان تختار  </option> ';
      $Result=FoodAvailable::SelectAll();
      for($k=1;$k<=count($Result);$k++)
      ...
      $cont3=Content::Button(44,"Delete");
      echo '
