            ...
            <div class="container-fluid">
                ...
                <div class="form-validation">
                    <form class="form-valide" method="post" id="form" name="myForm">
                            ...
                            <h3 style='text-align:center; color: rgba(45, 65, 21)'> اكتب بريد الطالب الالكتروني الذي تود مسح حجزه</h3>
                            <br>
                    ...
                    <div class="search-box" >
                        ...
                        <button type="submit" name="remove" class="btn btn-primary btn-flat m-b-30 m-t-30">مسح</button>
                        </form>
                        </div>
