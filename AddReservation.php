        ...
        $mail=$_POST['mail'];
                ...
                while($rowtwo = $resulttwo->fetch_assoc()){
                    if($rowtwo==true)
                    {
                        $id=$rowtwo['ID'];
                        $obj = new ReservRooms();
                        $obj->Room_ID=$_POST['RoomNo'];
                        $obj->Student_ID=$id;
                        $obj->DateFrom=$_POST['datefrom'];
                        $obj->DateTo=$_POST['dateto'];
                    
                        return ReservRooms::create($obj);
                    }
                }
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <!-- Start Page Content -->
                <br>
                                <h2 style='text-align:center; color: rgba(45, 65, 21)'> اضافة حجز غرفة</h2>
                                <div class="form-validation">
                                <form class="form-valide" method="post" id="searchform" name="myForm">
                                
									<div class="form-group">
                                    <label for="pass" class="label" for="val-email" style="margin-left: 83%;font-size:20px;color:black;">بريد الطالب الالكتروني<span class="text-danger">*</span></label>
                    ...
                    <div class="search-box" >
                            ...
                            <div class='result'></div>
                                    ...
                                    <div class="form-group">
                                    <label for="pass" class="label" for="val-email" style="margin-left: 90%;font-size:20px;color:black;">رقم المبنى<span class="text-danger">*</span></label>
                    ...
                    <?php
                            ...
                            $conn->query("SET NAMES 'utf8'");
                            $query="SELECT * FROM alazharuni.room ";
                            $resultQuery = $conn->query($query);
                            while($rowq = $resultQuery->fetch_assoc()){
                                if($rowq==true)
                                {
                                    $id=$rowq["BuildingNo"];
                                    $query="SELECT * FROM alazharuni.buildings WHERE ID=$id ";
                            $resultQuery = $conn->query($query);
                            while($rowq = $resultQuery->fetch_assoc()){
                                if($rowq==true)
                                {
